                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Редагування категорії {{$category->title}}</li>
                        </ol>
                    </div><!--col -->
                </div><!--/.row -->
            </div><!--/.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <form action="{{route('admin.ua.category.update', $category->id)}}" method="POST" class="w-25">
                            @csrf
                            @method('PATCH')
                            ...
                            <input type="submit" class="btn btn-primary mt-2" value="Оновити">
                        </form>
